                    ...
                    <CarouselContent className="-ml-4">
                        {featuredStories.map((story) => (
                            <CarouselItem key={story.id} className="pl-4 md:basis-1/3">
                                <Link 
                                    href={`/featured-stories/${story.slug}`}
                                    className="group flex flex-col overflow-hidden rounded-lg border border-green-900/40 bg-black/20 backdrop-blur-sm hover:border-green-600 transition-all duration-300 hover:shadow-[0_0_20px_rgba(8,142,72,0.2)] h-full"
                                >
                                    {/* Image */}
                                    <div className="relative aspect-[4/3] overflow-hidden">
                                        <img
                                            src={story.thumbnail || "/feature-stories.png"}
                                            alt={story.name}
                                    ...
                                    <div className="flex flex-col flex-1 p-5 gap-1">
                                        ...
                                        <p className="text-gray-400 text-sm mb-1">{story.location}, {story.province}</p>
