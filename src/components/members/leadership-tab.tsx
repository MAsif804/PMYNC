            ...
            <div className="group bg-white rounded-[12px] p-4 shadow-sm border border-[#E7E7E7] hover:shadow-lg hover:border-[#088E48]/30 transition-all duration-300 flex flex-col h-full group cursor-pointer">
                ...
                <div className="relative rounded-[8px] overflow-hidden mb-4 aspect-[4/3]">
                    ...
                    <div className="absolute top-3 right-3 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        {m.socials.linkedin && (
                            <a href={m.socials.linkedin} className="w-8 h-8 rounded-full bg-[#0076B2] shadow-sm flex items-center justify-center transition-colors">
                                <Linkedin className="w-4 h-4 fill-white text-white" />
                            </a>
                        )}
                        {m.socials.email && (
                            <a href={m.socials.email} className="w-8 h-8 rounded-full bg-white shadow-sm flex items-center justify-center transition-colors">
                        ...
                        {m.socials.phone && (
                            <a href={m.socials.phone} className="w-8 h-8 rounded-full bg-[#088E48] white shadow-sm flex items-center justify-center  transition-colors">
                            ...
                            <PaginationContent className="gap-0">
                                ...
                                {visiblePages.map((n) => (
                                    <PaginationItem key={n}>
                                        <PaginationLink
                                            href="#"
                                            onClick={(e) => { e.preventDefault(); handlePageChange(n); }}
