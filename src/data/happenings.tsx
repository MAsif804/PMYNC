...
export const happenings: Happening[] = [
    {
        ...
        dateStart: "Nov, 2025",
        dateEnd: "Dec, 2025",
        thumbnail: "/nyc-happening/happening-1.jpg",
    ...
    },
    {
        ...
        dateStart: "Nov, 2025",
        dateEnd: "Dec, 2025",
        thumbnail: "/nyc-happening/happening-2.jpg",
        shortDescription: "Annual gathering of young leaders from across Pakistan to discuss policy development, innovation, and youth empowerment strategies Annual gathering of y...",
        beneficiaries: "2500+",
        badge:"Blog",
        date: "",
    ...
    },
    {
        ...
        title: "The 2024 Scholarship Winners, selected for their dedication, leadership, and exceptional...",
        dateStart: "Nov, 2025",
        dateEnd: "Dec, 2025",
        thumbnail: "/nyc-happening/happening-3.png",
        shortDescription: "Annual gathering of young leaders from across Pakistan to discuss policy development, innovation, and youth empowerment strategies Annual gathering of y...",
        beneficiaries: "2500+",
        badge: "Story",
        date: "",
    ...
    },
    {
        ...
        title: "National Startup Pitch Competition: Connecting Innovative Entrepreneurs with In...",
        dateStart: "Jan, 2026",
        dateEnd: "Feb, 2026",
        thumbnail: "/nyc-happening/happening-4.jpg",
        shortDescription: "Annual gathering of young leaders from across Pakistan to discuss policy development, innovation, and youth empowerment strategies Annual gathering of y...",
        beneficiaries: "1800+",
        date: "Sunday, March 17, 9:00 AM",
        location: "Convention center, Islamabad, Pakistan",
    ...
    },
    {
        ...
        title: "Meeting with the UN Youth Envoy to discuss youth empowerment, leadership, and global opportunities.",
        dateStart: "Nov, 2025",
        dateEnd: "Dec, 2025",
        thumbnail: "/nyc-happening/happening-2.jpg",
        shortDescription: "Annual gathering of young leaders from across Pakistan to discuss policy development, innovation, and youth empowerment strategies Annual gathering of y... ",
    ...
    },
    {
        ...
        title: "Women Empowerment Forum: Breaking Barriers and Creating Opportunities",
        dateStart: "Nov, 2025",
        dateEnd: "Dec, 2025",
        thumbnail: "/nyc-happening/happening-9.png",
        shortDescription: "Annual gathering of young leaders from across Pakistan to discuss policy development, innovation, and youth empowerment strategies Annual gathering of y...",
        beneficiaries: "2500+",
        badge: "UpComing",
        date: "Sunday, March 17, 9:00 AM",
        location: "Pearl Continental Hotel, The Mall Road, Near GPO, Rawalpindi Cantt, Rawalpindi, Punjab, Pakistan",
        category: "Technology",
        attendees: "150+ Attendees",
        author: "",
        avatars: [
...
export function getHappeningBySlug(slug: string): Happening | undefined {
    return happenings.find((p) => p.slug === slug);
}
